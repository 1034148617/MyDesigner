<template>
    <n-layout has-sider sider-placement="right">
        ...
        <!-- 工具栏 -->
        <n-layout-sider collapse-mode="transform" :collapsed-width="0" :width="275" :collapsed="collapsed"
            ...
            <content-box class="my-content-configurations my-boderbox" :show-top="false" :depth="2">
                ...
                <!-- 编辑 -->
                <n-tabs v-if="selectTarget" v-model:value="tabsSelect" class="tabs-box" size="small" type="segment" :key="new Date().getTime">
